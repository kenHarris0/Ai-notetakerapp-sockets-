  ...
  const Rightnote = ({selectednote,groupId,setselectednote}) => {
    const [value, setValue] = useState("")
  const {url,getallnotes,userdata,socket,connectSocket,disconnectSocket,setnotes}=useContext(notecontext)
  ...
  const deleteNote = async () => {
    ...
    try {
      const res = await axios.post(
        url + '/note/delete',
        { noteId: selectednote._id, groupId },
      ...
      if (res.data) {
        ...
        setselectednote(prev=>prev._id===selectednote._id?null:prev)
  ...
  <MDEditor
          ...
          <div className='flex w-2/3 h-[10%] justify-start gap-5 items-center pl-10 -mt-15 z-50' >
  ...
  >
    <BrainCog /> <span>AI Summarize</span>
            ...
            <Trash className='w-12 h-12 cursor-pointer' onClick={deleteNote}/>
